 ...
 <head>
 	...
 	<title><?php echo $translation['ajouter_defi'][$lang]; ?></title>
 ...
 <body>
 	...
 	<div class="container">
 		<div class="page-header">
 			<h2><?php echo $translation['ajouter_defi'][$lang]; ?></h2>
 		</div>
		<?php if (isset($_SESSION['etat'])) {
			if ($_SESSION['etat']) {
				// succès
				if ($lang == "FR") {
					echo '<div class="row"><div class="alert alert-success" role="alert"><strong>Votre défi a bien été créé. </strong></div></div>';
				}else{
					// DE
					echo '<div class="row"><div class="alert alert-success" role="alert"><strong>Die Aufgabe wurde erfolgreich erstellt. </strong></div></div>';
				}
			}else{
				// echec
				if (isset($_SESSION['error'])) {
					...
					if ($lang == "FR") {
						echo '<div class="row"><div class="alert alert-danger" role="alert"><strong>Erreur votre défi n\'a pas été créé ! '.$_SESSION['errorFR'].'</div></div>';
					}else{
						// DE
						echo '<div class="row"><div class="alert alert-danger" role="alert"><strong>Fehler! Die Aufgabe wurde nicht erstellt. '.$_SESSION['errorDE'].'</div></div>';
					}
				}else{
					if ($lang == "FR") {
						echo '<div class="row"><div class="alert alert-danger" role="alert"><strong>Erreur votre défi n\'a pas été créé ! Veuillez vérifier que les différents champs soient bien remplis!</strong></div></div>';
					}else{
						// DE
						echo '<div class="row"><div class="alert alert-danger" role="alert"><strong>Fehler! Die Aufgabe wurde nicht erstellt. Bitte überprüfen, ob die verschiedenen Felder richtig ausgefüllt sind.</strong></div></div>';
					}
				}
			}
		} ?>
 		<div id="defiForm">
 			<form enctype="multipart/form-data" method="post" action="../model/addDefi.php">
 				<div id="edMap">
 			...
 			<div class="form-group">
 				...
 				<select name="langueDef" class="form-control" required>
 					<option disabled selected value></option>
			...
			<div class="form-group">
				...
				<select id="couleur" name="color" class="form-control" required>
					<option disabled selected value></option>
					<option data-ed="1" value="alsace">Nord Alsace</option>
					<option data-ed="2" value="mittlerer">Mittlerer Oberrhein</option>
					<option data-ed="3" value="sudpfalz">Südpfalz</option>
				</select>
			</div>
			<div id="LieuList">
			...
			<div class="form-group">
				<label><?php echo $translation['type_defi'][$lang]; ?> :</label>
				<select id="typeDef" name="defType" class="form-control" required>
					<option disabled selected value></option>
					<option value="QCM"><?php echo $translation['qcm'][$lang]; ?></option>
					<option value="vocale"><?php echo $translation['reconnaissance_vocale'][$lang]; ?><!-- Réponse vocale/texte --></option>
					<option value="frise"><?php echo $translation['frise_chronologique'][$lang]; ?></option>
					<option value="trou"><?php echo $translation['texte_a_trou'][$lang]; ?></option>
					<option value="classement"><?php echo $translation['classement_thematique'][$lang]; ?></option>
				</select>
			</div>

			<div id="selectedDefForm"></div>

			<!-- if QCM alors affiche modèle pour les QCM etc -->
			<!-- Upload -->
			<!-- prévisualisation -->
			<!-- classe école -->
			<!-- Date -->
			<div class="row">
				<div class="col-md-12">
					...
					<label style="display: inline;" for="propIntellec"><?php echo $translation['droit_prop_intellect'][$lang]; ?></label>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<input type="checkbox" name="" id="rightImg" required>
					<label style="display: inline;" for="rightImg"><?php echo $translation['droit_image'][$lang]; ?></label>
				</div>
			</div>
			<br>
			<div class="row">
				<div class="col-md-12 text-center">
					<button id="btnPreview" disabled="disabled" type="button" class="btn btn-primary disabled"><?php echo $translation['previsualisation'][$lang]; ?></button>
...
<script type="text/javascript">
	...
	// initialisation des variables suivant la langue de l'utilisateur pour le QCM
    var titre_Q = '<?php echo $translation['titre_question'][$lang]; ?>';
    var question = '<?php echo $translation['question'][$lang]; ?>';
    var rep = '<?php echo $translation['reponse'][$lang]; ?>';
    var repCorrect = '<?php echo $translation['numero_reponse_correcte'][$lang]; ?>';
    var imgIllust = '<?php echo $translation['image_illustration'][$lang]; ?>';
    var propImgIllust = '<?php echo $translation['proprietaire_image_illustration_defi'][$lang]; ?>';
    var aide_defi = '<?php echo $translation['aide_au_defi'][$lang]; ?>';
    var txt_aide_defi = '<?php echo $translation['texte_aide_defi'][$lang]; ?>';
    var txt_lisibe = '<?php echo $translation['taille_de_texte_lisibe'][$lang]; ?>';
    var txt_only = '<?php echo $translation['texte_seulement'][$lang]; ?>';
    var adresse = '<?php echo $translation['adresse_ou_nom_exacte_du_lieu'][$lang]; ?>';
    var no_map = '<?php echo $translation['pas_de_carte'][$lang]; ?>';
    var img_aide_defi = '<?php echo $translation['image_aide_defi'][$lang]; ?>';
    var prop_img_aide_defi = '<?php echo $translation['prop_image_aide_defi'][$lang]; ?>';
    var video_aide_defi = '<?php echo $translation['video_aide_defi'][$lang]; ?>';
    var prop_video_aide_defi = '<?php echo $translation['prop_video_aide_defi'][$lang]; ?>';
    var audio_aide_defi = '<?php echo $translation['audio_aide_defi'][$lang]; ?>';
    var prop_audio_aide_defi = '<?php echo $translation['prop_audio_defi'][$lang]; ?>';
    var lieuDefi = '<?php echo $translation['lieu'][$lang]; ?>';

    // initialisation des variables suivant la langue de l'utilisateur pour la reconnaissance vocale
    var mots_cles = '<?php echo $translation['mots_cles'][$lang]; ?>';
    var exemple_rep = '<?php echo $translation['exemple_de_reponse'][$lang]; ?>';
    var pas_de_point_virgule = '<?php echo $translation['pas_de_point_virgule'][$lang]; ?>';
    var laissez_un_espace = '<?php echo $translation['laissez_un_espace'][$lang]; ?>';

    // initialisation des variables suivant la langue de l'utilisateur pour la frise chronologique
    var date_debut_frise = '<?php echo $translation['date_debut_frise'][$lang]; ?>';
    var date_fin_frise = '<?php echo $translation['date_fin_frise'][$lang]; ?>';
    var titre_frise = '<?php echo $translation['titre_frise'][$lang]; ?>';
    var evenement_n = '<?php echo $translation['evenement_n'][$lang]; ?>';
    var nom_evenement = '<?php echo $translation['nom_evenement'][$lang]; ?>';
    var date_evenement = '<?php echo $translation['date_evenement'][$lang]; ?>';
    var vignette_evenement = '<?php echo $translation['vignette_evenement'][$lang]; ?>';
    var proprietaire_image = '<?php echo $translation['proprietaire_image'][$lang]; ?>';

    // initialisation des variables suivant la langue de l'utilisateur pour le texte à trou
    var TAT = '<?php echo $translation['texte_a_trou'][$lang]; ?>';
    var exemple_input = '<?php echo $translation['exemple_input'][$lang]; ?>';
    var remplacer_mot_input = '<?php echo $translation['remplacer_mot_input'][$lang]; ?>';
    var nb_mot_input = '<?php echo $translation['nb_mot_input'][$lang]; ?>';

    // initialisation des variables suivant la langue de l'utilisateur pour le classement thématique
    var nombre_de_categorie = '<?php echo $translation['nombre_de_categorie'][$lang]; ?>';
    var type_etiquette = '<?php echo $translation['type_etiquette'][$lang]; ?>';
    var categorie = '<?php echo $translation['categorie'][$lang]; ?>';
    var vignette = '<?php echo $translation['vignette'][$lang]; ?>';
    var groupe_de_mots = '<?php echo $translation['groupe_de_mots'][$lang]; ?>';
    var image = '<?php echo $translation['image'][$lang]; ?>';
    var mot = '<?php echo $translation['mot'][$lang]; ?>';
    
</script>
<script src="../js/ajoutDefi.js"></script>
<script type="text/javascript">
	function openHelp() {
