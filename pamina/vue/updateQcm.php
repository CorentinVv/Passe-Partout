<div id="defiForm">
	<form enctype="multipart/form-data" method="post" action="../model/updateDefi/updateDefiQcm.php">
	<input type="hidden" name="idQcm" id="idQcm">
		<div id="edMap">
...
<!-- 	<div class="form-group">
	...
	<div id="QCM" >
		<div class="form-group">
			...
			<input type="text" id="titreQuestion" class="form-control" name="titleQuest" maxlength="75" required>
		</div>

		<div class="form-group">
			<label><?php echo $translation['question'][$lang]; ?> :</label>
			<input type="text" id="question" class="form-control" name="question" maxlength="150" required>
		</div>

		<div class="form-group">
			<label><?php echo $translation['reponse'][$lang]; ?> 1 :</label>
			<input type="text" id="rep1" class="form-control" name="rep1" maxlength="50" required>
		</div>

		<div class="form-group">
			<label><?php echo $translation['reponse'][$lang]; ?> 2 :</label>
			<input type="text" id="rep2" class="form-control" name="rep2" maxlength="50" required>
		</div>

		<div class="form-group">
			<label><?php echo $translation['reponse'][$lang]; ?> 3 :</label>
			<input type="text" id="rep3" class="form-control" name="rep3" maxlength="50" required>
		</div>

		<div class="form-group">
			<label><?php echo $translation['reponse'][$lang]; ?> 4 :</label>
			<input type="text" id="rep4" class="form-control" name="rep4" maxlength="50" required>
		</div>
		<div class="form-group">
			<label><?php echo $translation['reponse'][$lang]; ?> 5 :</label>
			<input type="text" id="rep5" class="form-control" name="rep5" maxlength="50" required>
		</div>
		<div class="form-group"> 
			<label><?php echo $translation['numero_reponse_correcte'][$lang]; ?> :</label> 
		...
		<label><?php echo $translation['image_illustration2'][$lang]; ?> :</label> 
		<input type="file" id="imageDefiPrev" name="imageDefi" accept="image/*"> 
		<input type="text" id="imageDefiOld" name="imageDefiOld" style="display: none;">
		<br>
		<!-- aperçu de l'ancienne image -->
		<div class="form-group">
			<label style="color: #009688;">Image actuelle : </label>
		</div>
		<img class="img-responsive img-thumbnail img-preview" id="imgShowOld" src="">

		<br/>
		<div class="input-group"><span class="input-group-addon"><?php echo $translation['proprietaire_image_illustration_defi2'][$lang]; ?> : </span><input id="ImgAuteur" type="text" class="form-control" name="ImgAuteur" maxlength="25"></div><br/>
		<div class="form-group"><label>Copyright :</label><select id="copyrightImgQcm" name="copyrightImgQcm" class="form-control"><option disabled="" selected="" value=""></option><option value="cr1">CC 0 - public domain</option><option value="cr2">CC BY</option><option value="cr3">CC BY SA</option><option value="cr4">CC BY SA ND</option><option value="cr5">CC BY SA NC</option></select></div>

		<div class="page-header"> 
			<h2><?php echo $translation['aide_au_defi'][$lang]; ?></h2><hr> 
			<label for="aideTxt"><?php echo $translation['texte_aide_defi2'][$lang]; ?> : </label><br/> 
			<!-- <textarea rows="6" cols="50" name="aideTxt"></textarea> --> 
			<textarea class="editor" rows="6" cols="50" name="editor"></textarea> <br/><br/> 
			...
			<input type="file" id="aideImg" name="aideImg" accept="image/*"><br/> 
			...
			<input type="file" id="aideVideo" name="aideVideo" accept="video/mp4,video/*"> <br/>
			...
			<input type="file" id="aideSon" name="aideSon" accept="audio/*"><br/>
