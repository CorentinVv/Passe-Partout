		...
		$.ajax({                                      
			...
			success: function(data)
			{
                try {
                    ...
                    $output = '<table class="table table-hover"><thead><tr><th>ID</th><th>'+titre+'</th><th>'+lieuDefi+'</th></tr></thead><tbody>';

                    if (tDefi == "frise") {
                        $.each(res, function(i, item) {
                            $output += "<tr><td>"+res[i].id+"</td><td>"+res[i].titre_frise+"</td><td>"+res[i].lieu+"</td><td class='idOwner' style='display:none;'>"+res[i].createur_id+"</td><td><button type='button' id='deleteDefi"+res[i].id+"' class='btn btn-default'><span class='glyphicon glyphicon-trash'></span></button></td></tr>";
                        });
                    }else{
                        $.each(res, function(i, item) {
                            $output += "<tr><td>"+res[i].id+"</td><td>"+res[i].titre_question+"</td><td>"+res[i].lieu+"</td><td class='idOwner' style='display:none;'>"+res[i].createur_id+"</td><td><button type='button' id='deleteDefi"+res[i].id+"' class='btn btn-default'><span class='glyphicon glyphicon-trash'></span></button></td></tr>";
                        });
                    }
                    ...
                    if (typeDefiSelect == "Qcm") {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                $('#remarqueQcm').text(dataRes.remarque);
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                dataRes = dataRes[0];
                                // REMPLISSAGE DES CHAMPS AVEC LES DONNEES
                                $('#remarqueTrou').text(dataRes.remarque);
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                dataRes = dataRes[0];
                                // REMPLISSAGE DES CHAMPS AVEC LES DONNEES
                                $('#remarqueVocal').text(dataRes.remarque);
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                dataRes = dataRes[0];
                                // REMPLISSAGE DES CHAMPS AVEC LES DONNEES
                                $('#remarqueFrise').text(dataRes.remarque);
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                dataRes = dataRes[0];
                                // REMPLISSAGE DES CHAMPS AVEC LES DONNEES
                                $('#remarqueClassement').text(dataRes.remarque);
