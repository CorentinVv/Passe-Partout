...
<div onclick="event.stopPropagation()" class="modal">
	...
	<div style="width: 100%;height: 30%;/* margin-top: 7%; */margin-bottom: 4%;display: inline-flex;">
		<div style="margin-left: 3%;width: 100%;text-align: center;">
			<h4 class="titleQuestion"><?php echo $_POST['titre']; ?></h4>
			<p style="font-size: large;"><?php echo $_POST['question']; ?></p>
		</div>
	</div>
	<div style="display: block;width: 100%;text-align: center;height: 20%;">
		<div id="mic">
			 ...
			 <div id="resVoice"></div>
			 <div style="position: absolute;top: 75%;left: 26%;">
			 	<button id="iHaveNoMic">Je n'ai pas de micro</button>
			 </div>
		 </div>
		 <div id="noMic">
		 	<input id="inputNoMic" type="text" name="textRep">
		    <button id="btnNoMic">Répondre</button>
		    <div id="resText"></div>
		 </div>
	</div>
	<div class="footDefi">
...
<!-- 		<div class="validation">
			<img onclick="valDefi()" onmouseover="this.src='/pamina/img/Defi/bleu/valideonnordals.png'" onmouseout="this.src='/pamina/img/Defi/bleu/validoffnordals.png'" src="/pamina/img/Defi/bleu/validoffnordals.png">
		</div> -->
	</div>
	...
	<div id="cacheAide" style="display: none">
		<div id="aidePopup">
			...
			<div id="bodyHelp">
				<div id="questionHelp"><?php echo $_POST['question']; ?></div>
				<div id="imgsHelp">
				...
				<div id="mediaHelp">
					<?php if ($_POST['helpVideo'] != null) {
						echo "<video class='mediaStop' width='260px' src='/pamina/uploadDefi/aide/video/".$_POST['helpVideo']."' controls>Veuillez mettre à jour votre navigateur !</video>";
					} ?>
					<?php if ($_POST['helpAudio'] != null) {
						echo "<audio class='mediaStop' style='width:35%;' src='/pamina/uploadDefi/aide/son/".$_POST['helpAudio']."' controls>Veuillez mettre à jour votre navigateur !</audio>";
					} ?>
