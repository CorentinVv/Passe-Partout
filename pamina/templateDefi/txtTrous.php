...
<div onclick="event.stopPropagation()" class="modal">
	...
	<div class="contentTrous">
		<div class="titreTrous">
			...
			<p class="questionTrous"><?php echo $_POST['question']; ?></p>
		</div>
		<div style="width: 90%;margin-left: 5%;overflow: overlay;height: 70%;">
			<p><?php echo $_POST['TAT']; ?></p>
		</div>
	</div>
			...
			<div id="bodyHelp">
				...
				<div id="imgsHelp">
					<?php if ($_POST['helpImg'] != null) {
						if (pathinfo($_POST['helpImg'], PATHINFO_EXTENSION) == "pdf") {
							echo "<object width='100%' data='/pamina/uploadDefi/TexteTrou/aide/img/".$_POST['helpImg']."' type='application/pdf'></object>";
						}else{
							// echo "<img style='width: 220px;height: 160px;background-color: red;margin-right: 10%;' src='/pamina/uploadDefi/TexteTrou/aide/img/".$_POST['helpImg']."'></img>";
							echo "<div class='thumbnail'>";
							echo "<img style='width: 220px;height: 160px;margin-right: 10%;' src='/pamina/uploadDefi/TexteTrou/aide/img/".$_POST['helpImg']."'></img>";
				...
				<div id="mediaHelp">
					<?php if ($_POST['helpVideo'] != null) {
						echo "<video class='mediaStop' width='260px' src='/pamina/uploadDefi/TexteTrou/aide/video/".$_POST['helpVideo']."' controls>Veuillez mettre à jour votre navigateur !</video>";
					} ?>
					<?php if ($_POST['helpAudio'] != null) {
						echo "<audio class='mediaStop' style='width:35%;' src='/pamina/uploadDefi/TexteTrou/aide/son/".$_POST['helpAudio']."' controls>Veuillez mettre à jour votre navigateur !</audio>";
					} ?>
