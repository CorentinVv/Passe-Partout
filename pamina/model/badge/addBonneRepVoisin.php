<?php
	...
	if (!($req = $con->prepare("UPDATE Utilisateur SET nb_reponse_langue_voisin = nb_reponse_langue_voisin + 1 WHERE id=?"))) {
	...
	// Par ED
	$sql = "UPDATE Utilisateur SET nb_reponse_langue_voisin_".$ed." = nb_reponse_langue_voisin_".$ed." + 1 WHERE id=?";
