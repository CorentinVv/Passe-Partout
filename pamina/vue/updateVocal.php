<div id="defiForm">
	<form enctype="multipart/form-data" method="post" action="../model/updateDefi/updateDefiVocal.php">
		<input type="hidden" name="idVocal" id="idVocal">
		<div id="edMap">
...
<!-- 		<div class="form-group">
		...
		<div id="vocale">
			<div class="form-group">
				...
				<input type="text" id="titreQuestionVocaTxt" class="form-control" name="titleQuestVocaTxt" maxlength="75" required>
			</div>
			<div class="form-group">
				<label><?php echo $translation['question'][$lang]; ?> :</label>
				<input type="text" id="questionVocaTxt" class="form-control" name="questionVocaTxt" maxlength="150" required>
			</div>
			<div class="form-group">
				<label><?php echo $translation['reponse'][$lang]; ?> :</label>
				<input type="text" id="repVocale" class="form-control" name="repVocale" placeholder="exemple de réponse" maxlength="50" required>
				<small id="repHelp" class="form-text text-muted"><?php echo $translation['pas_de_point_virgule2'][$lang]; ?></small>
			</div>
			<div class="form-group">
				<label><?php echo $translation['mots_cles'][$lang]; ?> :</label>
				<input type="text" id="repCle" class="form-control" name="repCle" placeholder="eau argile pot" required>
				<small id="repHelp" class="form-text text-muted"><?php echo $translation['laissez_un_espace'][$lang]; ?></small>
			</div>
			<div class="page-header">
				...
				<textarea id="editorVoca" class="editor" rows="6" cols="50" name="editorVocaTxt">Texte seulement ! Voir les champs ci dessous pour les images/vidéos/audios</textarea><br/><br/>
				...
				<input type="file" id="aideImgVocaTxt" name="aideImgVocaTxt" accept="image/*"><br/>
				...
				<input type="file" id="aideVideoVocaTxt" name="aideVideoVocaTxt" accept="video/mp4,video/*"><br/>
				...
				<input type="file" id="aideSonVocaTxt" name="aideSonVocaTxt" accept="audio/*"><br/>
