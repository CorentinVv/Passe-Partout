...
(function(dice) {
    ...
    this.material_options = {
        // Couleur de brillance sur la face de résultat
        specular: 0x172022,
        // Couleur du dé reflexion ?
        color: 0xf0f0f0,
        // Intensité de la lumière
        shininess: 10,
        shading: THREE.FlatShading,
    };
    // Couleur des numéros du dé
    this.label_color = '#aaaaaa';
    // Couleur des faces du dé
    this.dice_color = '#9e2f76';
    // Couleur lumière ambiante (comme la lumière invisible dans une pièce du soleil)
    this.ambient_light_color = "#ffffff";
    // Couleur de la lumière (comme une ampoule)
    this.spot_light_color = "#727275";
    // option scene de départ (Couleur de fond/Intensité de la lumière/lumière ambiante?)
    this.selector_back_colors = { color: "#e0b162", shininess: 10, emissive: "#000000" };
    // Couleur de fond jeté de dé
    this.desk_color = "#e0b162";
    // this.desk_color = "#bed148";
    ...
    this.create_d6 = function() {
        // Taille du dé
        if (!this.d6_geometry) this.d6_geometry = this.create_d6_geometry(150);
    ...
    this.dice_box.prototype.reinit = function(container, dimentions) {
        ...
        this.desk = new THREE.Mesh(new THREE.PlaneGeometry(this.w * 200, this.h * 200, 1, 1), 
