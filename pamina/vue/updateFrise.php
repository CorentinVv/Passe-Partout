<div id="defiForm">
	<form enctype="multipart/form-data" method="post" action="../model/updateDefi/updateDefiFrise.php">
		<input type="hidden" name="idFrise" id="idFrise">
		<div id="edMap">
...
<!-- 		<div class="form-group">
		...
		<div id="frise">
			<div class="form-group">
				<label><?php echo $translation['titre_frise'][$lang]; ?> :</label>
				<input type="text" id="titreFrise" class="form-control" name="titreFrise" maxlength="40" required>
			</div>
			<div class="form-group">
				<label><?php echo $translation['date_debut_frise'][$lang]; ?> :</label>
				<input type="number" id="dateDebFrise" class="form-control" name="dateDebFrise" required>
			</div>
			<div class="form-group">
				<label><?php echo $translation['date_fin_frise'][$lang]; ?> :</label>
				<input type="number" id="dateFinFrise" class="form-control" name="dateFinFrise" required>
				</div>
			<!-- EVENEMENT -->
			<div class="form-group">
				<h2><?php echo $translation['evenement_n'][$lang]; ?>1</h2><hr>
				<label><?php echo $translation['nom_evenement2'][$lang]; ?> :</label>
				<input type="text" maxlength="60" id="eventName1" class="form-control" name="eventName1" required>
				<label><?php echo $translation['date_evenement2'][$lang]; ?> :</label>
				<input type="number" id="eventDate1" class="form-control" name="eventDate1" required>
				<label><?php echo $translation['vignette_evenement2'][$lang]; ?> :</label>
				<input type="file" id="etiquette1Prev" name="eventImg1" accept="image/*">
				<input type="text" id="eventOldImg1" name="eventOldImg1" style="display: none;">
				<br/>

				<!-- aperçu de l'ancienne vignette -->
				<div class="form-group">
					<label style="color: #009688;">Vignette actuelle : </label>
				</div>
				<img class="img-responsive img-thumbnail vign-preview" id="vignetteShowOld1" src="">

				<div class="input-group">
					<span class="input-group-addon"><?php echo $translation['proprietaire_image2'][$lang]; ?> : </span>
					<input id="eventImg1Auteur" type="text" class="form-control" name="eventImg1Auteur">
				</div><br/>

				<div class="form-group">
					<label>Copyright :</label>
					<select id="copyrightEventImg1" name="copyrightEventImg1" class="form-control" required="">
						<option disabled="" selected="" value=""></option>
			...
			<div class="form-group">
				<h2><?php echo $translation['evenement_n'][$lang]; ?>2</h2><hr>
				<label><?php echo $translation['nom_evenement2'][$lang]; ?> :</label>
				<input type="text" maxlength="60" id="eventName2" class="form-control" name="eventName2" required>
				<label><?php echo $translation['date_evenement2'][$lang]; ?> :</label>
				<input type="number" id="eventDate2" class="form-control" name="eventDate2" required>
				<label><?php echo $translation['vignette_evenement2'][$lang]; ?> :</label>
				<input type="file" id="etiquette2Prev" name="eventImg2" accept="image/*">
				<input type="text" id="eventOldImg2" name="eventOldImg2" style="display: none;">
				<br/>
				...
				<img class="img-responsive img-thumbnail vign-preview" id="vignetteShowOld2" src="">

				<div class="input-group">
					<span class="input-group-addon"><?php echo $translation['proprietaire_image2'][$lang]; ?> : </span>
					<input id="eventImg2Auteur" type="text" class="form-control" name="eventImg2Auteur">
				</div><br/>

				<div class="form-group">
					<label>Copyright :</label>
					<select id="copyrightEventImg2" name="copyrightEventImg2" class="form-control" required="">
						<option disabled="" selected="" value=""></option>
						<option value="cr1">CC 0 - public domain</option>
						<option value="cr2">CC BY</option>
						<option value="cr3">CC BY SA</option>
			...
			<div class="form-group">
				<h2><?php echo $translation['evenement_n'][$lang]; ?>3</h2><hr>
				<label><?php echo $translation['nom_evenement2'][$lang]; ?> :</label>
				<input type="text" maxlength="60" id="eventName3" class="form-control" name="eventName3" required>
				<label><?php echo $translation['date_evenement2'][$lang]; ?> :</label>
				<input type="number" id="eventDate3" class="form-control" name="eventDate3" required>
				<label><?php echo $translation['vignette_evenement2'][$lang]; ?> :</label>
				<input type="file" id="etiquette3Prev" name="eventImg3" accept="image/*">
				<input type="text" id="eventOldImg3" name="eventOldImg3" style="display: none;">
				<br/>
				...
				<img class="img-responsive img-thumbnail vign-preview" id="vignetteShowOld3" src="">

				<div class="input-group">
					<span class="input-group-addon"><?php echo $translation['proprietaire_image2'][$lang]; ?> : </span>
					<input id="eventImg3Auteur" type="text" class="form-control" name="eventImg3Auteur">
				</div><br/>

				<div class="form-group">
					<label>Copyright :</label>
					<select id="copyrightEventImg3" name="copyrightEventImg3" class="form-control" required="">
						<option disabled="" selected="" value=""></option>
						<option value="cr1">CC 0 - public domain</option>
						<option value="cr2">CC BY</option>
						<option value="cr3">CC BY SA</option>
			...
			<div class="form-group">
				<h2><?php echo $translation['evenement_n'][$lang]; ?>4</h2><hr>
				<label><?php echo $translation['nom_evenement2'][$lang]; ?> :</label>
				<input type="text" maxlength="60" id="eventName4" class="form-control" name="eventName4" required>
				<label><?php echo $translation['date_evenement2'][$lang]; ?> :</label>
				<input type="number" id="eventDate4" class="form-control" name="eventDate4" required>
				<label><?php echo $translation['vignette_evenement2'][$lang]; ?> :</label>
				<input type="file" id="etiquette4Prev" name="eventImg4" accept="image/*">
				<input type="text" id="eventOldImg4" name="eventOldImg4" style="display: none;">
				<br/>
				...
				<img class="img-responsive img-thumbnail vign-preview" id="vignetteShowOld4" src="">

				<div class="input-group">
					<span class="input-group-addon"><?php echo $translation['proprietaire_image2'][$lang]; ?> : </span>
					<input id="eventImg4Auteur" type="text" class="form-control" name="eventImg4Auteur">
				</div><br/>

				<div class="form-group">
					<label>Copyright :</label>
					<select id="copyrightEventImg4" name="copyrightEventImg4" class="form-control" required="">
						<option disabled="" selected="" value=""></option>
						<option value="cr1">CC 0 - public domain</option>
						<option value="cr2">CC BY</option>
						<option value="cr3">CC BY SA</option>
			...
			<div class="form-group">
				<h2><?php echo $translation['evenement_n'][$lang]; ?>5</h2><hr>
				<label><?php echo $translation['nom_evenement2'][$lang]; ?> :</label>
				<input type="text" maxlength="60" id="eventName5" class="form-control" name="eventName5" required>
				<label><?php echo $translation['date_evenement2'][$lang]; ?> :</label>
				<input type="number" id="eventDate5" class="form-control" name="eventDate5" required> 
				<label><?php echo $translation['vignette_evenement2'][$lang]; ?> :</label>
				<input type="file" id="etiquette5Prev" name="eventImg5" accept="image/*">
				<input type="text" id="eventOldImg5" name="eventOldImg5" style="display: none;">
				<br/>
				...
				<img class="img-responsive img-thumbnail vign-preview" id="vignetteShowOld5" src="">

				<div class="input-group">
					<span class="input-group-addon"><?php echo $translation['proprietaire_image2'][$lang]; ?> : </span>
					<input id="eventImg5Auteur" type="text" class="form-control" name="eventImg5Auteur">
				</div><br/>

				<div class="form-group">
					<label>Copyright :</label>
					<select id="copyrightEventImg5" name="copyrightEventImg5" class="form-control" required="">
						<option disabled="" selected="" value=""></option>
						<option value="cr1">CC 0 - public domain</option>
						<option value="cr2">CC BY</option>
						<option value="cr3">CC BY SA</option>
			...
			<div class="form-group">
				<h2><?php echo $translation['evenement_n'][$lang]; ?>6</h2><hr>
				<label><?php echo $translation['nom_evenement2'][$lang]; ?> :</label>
				<input type="text" maxlength="60" id="eventName6" class="form-control" name="eventName6" required>
				<label><?php echo $translation['date_evenement2'][$lang]; ?> :</label>
				<input type="number" id="eventDate6" class="form-control" name="eventDate6" required>
				<label><?php echo $translation['vignette_evenement2'][$lang]; ?> :</label>
				<input type="file" id="etiquette6Prev" name="eventImg6" accept="image/*">
				<input type="text" id="eventOldImg6" name="eventOldImg6" style="display: none;">
				<br/>
				...
				<img class="img-responsive img-thumbnail vign-preview" id="vignetteShowOld6" src="">

				<div class="input-group">
					<span class="input-group-addon"><?php echo $translation['proprietaire_image2'][$lang]; ?> : </span>
					<input id="eventImg6Auteur" type="text" class="form-control" name="eventImg6Auteur">
				</div><br/>

				<div class="form-group">
					<label>Copyright :</label>
					<select id="copyrightEventImg6" name="copyrightEventImg6" class="form-control" required="">
						<option disabled="" selected="" value=""></option>
						<option value="cr1">CC 0 - public domain</option>
						<option value="cr2">CC BY</option>
						<option value="cr3">CC BY SA</option>
			...
			<div class="page-header">
				...
				<textarea id="editorFrise" class="editor" rows="6" cols="50" name="editorFrise">Texte seulement ! Voir les champs ci dessous pour les images/vidéos/audios</textarea> <br/><br/>
				<div class="input-group">
				...
				<input type="file" id="aideImgFrise" name="aideImgFrise" accept="image/*"><br/>
				...
				<input type="file" id="aideVideoFrise" name="aideVideoFrise" accept="video/mp4,video/*"><br/>
				...
				<input type="file" id="aideSonFrise" name="aideSonFrise" accept="audio/*"><br/>
