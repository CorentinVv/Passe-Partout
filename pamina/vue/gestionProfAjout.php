...
<body>
<div>
	<a href="profBoard.php" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> <?php echo $translation['retour'][$lang]; ?></a>
</div>
	<div class="container">
		<div class="page-header">
			<h2><?php echo $translation['ajouter_classe'][$lang]; ?></h2>
		</div>
		<div>
			<div class="msgInfo alert alert-danger hide"><strong><?php echo $translation['ajouter_classe_warning'][$lang]; ?></strong></div>
			<form method="post" action="../model/ajoutClasse.php">
				<div class="form-group">
					<label><?php echo $translation['nom_classe'][$lang]; ?> :</label>
					<input type="text" class="form-control" name="className">
				</div>
				<div class="form-group">
					<label><?php echo $translation['nombre_enfants2'][$lang]; ?> :</label>
					<input type="number" min="0" class="form-control" name="nbClassChild">
				</div>
				<div class="form-group">
				    <label><?php echo $translation['choisissez_eurodistrict_classe'][$lang]; ?> :</label>
				    <select name="edClasse" class="form-control" required>
				      <option disabled selected value></option>
					  <option value="ED1">PAMINA </option>
					  <option value="ED2">Strasbourg Ortenau </option>
					  <option value="ED3">Freibourg Centre Sud Alsace </option>
					  <option value="ED4">Bâle Trinational </option>
					</select>
					<small><?php echo $translation['classement_eurodistrict'][$lang]; ?></small>
				</div>
				<div class="row">
		...
		<div class="page-header">
			<h2><?php echo $translation['ajouter_groupe'][$lang]; ?></h2>
		</div>
		<div>
			<form method="post" action="../model/ajoutGroupe.php">
			  <div class="form-group">
			    <label><?php echo $translation['identifiant'][$lang]; ?> :</label>
			    <input type="text" id="username" class="form-control" name="username" required>
			    <div id="usernameHint"></div>
			  </div>
			  <div class="form-group">
			    <label><?php echo $translation['mot_de_passe'][$lang]; ?> :</label>
			    <input type="password" id="password" class="form-control" name="pwd" required>
			  </div>
			  <div class="form-group">
			    <label><?php echo $translation['confirmation_mot_de_passe'][$lang]; ?> :</label>
			    <input type="password" id="conf_password" class="form-control" name="confpwd" required>
			  </div>
			  <div class="form-group">
			    <label><?php echo $translation['nom_groupe'][$lang]; ?> :</label>
			    <input type="text" class="form-control" name="groupName" required>
			  </div>
			  <div class="form-group">
			    <label><?php echo $translation['nombre_enfants_groupe2'][$lang]; ?> :</label>
			    <input type="number" min="0" class="form-control" name="nbGroupChild" required>
			  </div>
			  ...
			  <div class="form-group">
			    <label><?php echo $translation['tranche_age_groupe'][$lang]; ?> :</label>
			    <select name="trancheAge" class="form-control" required>
			      <option disabled selected value></option>
				  <option value="5-7">5-7 <?php echo $translation['ans'][$lang]; ?></option>
				  <option value="7-9">7-9 <?php echo $translation['ans'][$lang]; ?></option>
				  <option value="9-11">9-11 <?php echo $translation['ans'][$lang]; ?></option>
				  <option value="11-13">11-13 <?php echo $translation['ans'][$lang]; ?></option>
				</select>
			  </div>
			  <!-- <div class="form-group">
			  ...
			  <div class="form-group">
				...
				<div style="margin-bottom: 50px;">
					<small><strong><?php echo $translation['choisissez_eurodistrict_groupe'][$lang]; ?></strong></small>
				</div>
				  <div class="form-group">
				    <label><?php echo $translation['langue_maternelle'][$lang]; ?> :</label>
				    <select name="langueMat" class="form-control" required>
				      <option disabled selected value></option>
				  ...
				  <div class="form-group">
				    ...
				    <select name="langueJeu" class="form-control" required>
				      <option disabled selected value></option>
					  <option value="FR">FR</option>
					  <option value="DE">DE</option>
				  ...
				  <div class="form-group">
				  	<div unselectable="on" id="pionSelector">
				  	<label style="margin-right: 2%;"><?php echo $translation['choix_pion'][$lang]; ?> :</label>
				  		<span onclick="prevPion()" class="glyphicon glyphicon-chevron-left"></span><img id="pionCurrent" width="200px" height="auto" src="../img/Pions/pions-01.png"><span onclick="nextPion()" class="glyphicon glyphicon-chevron-right"></span>
				  		<input id="inputPionCurrent" type="text" name="imgPion">
				  	</div>
				  </div>
				  <?php 
				  	if ($lang == 'FR') {
				  		echo '<div class="checkbox">	<label><input name="checkCGU" required id="checkCGU" type="checkbox" value="1"> J\'ai lu et j\'accepte les <a target="_blank" href="generique/mentions.html#CGU">conditions générales d\'utilisation</a></label></div>';
				  	}else{
				  		echo '<div class="checkbox">	<label><input name="checkCGU" required id="checkCGU" type="checkbox" value="1"> Ich habe die <a target="_blank" href="generique/impressum.html#CGU">Nutzungsbedingungen</a> gelesen und erkläre mich damit einverstanden.</label></div>';
				  	}
				  ?>
				<div class="row">
					<div class="col-md-12 text-center">
	...
	<script src="../js/pamina.js"></script>
	<script type="text/javascript">

		var current = 1;
		$('#inputPionCurrent').val("../img/Pions/pions-0"+current+".png");
		...
		function prevPion() {
			...
			var src = "../img/Pions/pions-0"+current+".png";
			$('#pionCurrent').attr("src", src);
			$('#inputPionCurrent').val(src);
		}
