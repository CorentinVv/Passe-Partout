...
<div onclick="event.stopPropagation()" class="modal">
	...
	<div class="classementBody">
		<div class="titreClassement"><h1><?php if ($_POST['question'] != null) {echo $_POST['question'];} ?></h1></div>
		<div class="classementGame">

			<?php 

				if ($_POST['typeEtiquette'] == 1) {
					$typeEtiquette = "mot";
				}else if ($_POST['typeEtiquette'] == 2) {
					$typeEtiquette = "grpMot";
				}else if ($_POST['typeEtiquette'] == 3) {
					$typeEtiquette = "imageClmt";
				}

				// création des étiquettes
				for ($j=1; $j <= ($_POST['nbValisette']); $j++) { 
					for ($k=1; $k <= 5; $k++) { 
						...
						if ($_POST['typeEtiquette'] != 3) {
							echo "<div style='top: ".$top."%;left: ".$left."%;' class='etiquetteClassement ".$typeEtiquette."'>".$_POST['valise'.$j.'etiquette'.$k]."</div>";
						}else{
							echo "<div style='top: ".$top."%;left: ".$left."%;' class='etiquetteClassement ".$typeEtiquette."'><img style='width: 100%;' src='../uploadDefi/Classement/".$_POST['valise'.$j.'etiquette'.$k]."'></div>";
						}
					}
				}
				...
				// création des boites
				$classNbVal = '';
				if ($_POST['nbValisette'] == 4) {
					$classNbVal = 'classNbVal4';
				}else if ($_POST['nbValisette'] == 3) {
					$classNbVal = 'classNbVal3';
				}
				for ($i=1; $i <= $_POST['nbValisette']; $i++) { 
					echo "<div id='valise".$i."'>";
					echo '<img src="../img/Defi/classement/caisseclose.png" class="'.$classNbVal.' boiteClassement'.$i.'">';
					echo '<div class="'.$classNbVal.' nameboiteClassement'.$i.'">';
					echo $_POST['nomValise'.$i].'</div>';
					echo "</div>";
				}
			?>
			...
			<div id="bodyHelp">
				...
				<div id="imgsHelp">
					<?php if ($_POST['helpImg'] != null) {
						if (pathinfo($_POST['helpImg'], PATHINFO_EXTENSION) == "pdf") {
							echo "<object width='100%' data='/pamina/uploadDefi/Classement/aide/img/".$_POST['helpImg']."' type='application/pdf'></object>";
						}else{
							// echo "<img style='width: 220px;height: 160px;background-color: red;margin-right: 10%;' src='/pamina/uploadDefi/Classement/aide/img/".$_POST['helpImg']."'></img>";
							echo "<div class='thumbnail'>";
							echo "<img style='width: 220px;height: 160px;margin-right: 10%;' src='/pamina/uploadDefi/Classement/aide/img/".$_POST['helpImg']."'></img>";
				...
				<div id="mediaHelp">
					<?php if ($_POST['helpVideo'] != null) {
						echo "<video class='mediaStop' width='260px' src='/pamina/uploadDefi/Classement/aide/video/".$_POST['helpVideo']."' controls>Veuillez mettre à jour votre navigateur !</video>";
					} ?>
					<?php if ($_POST['helpAudio'] != null) {
						echo "<audio class='mediaStop' style='width:35%;' src='/pamina/uploadDefi/Classement/aide/son/".$_POST['helpAudio']."' controls>Veuillez mettre à jour votre navigateur !</audio>";
					} ?>
