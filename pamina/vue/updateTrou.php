<div id="defiForm">
	<form enctype="multipart/form-data" method="post" action="../model/updateDefi/updateDefiTrou.php">
		<input type="hidden" name="idTrou" id="idTrou">
		<div id="edMap">
...
<!-- 		<div class="form-group">
		...
		<div id="trou">
			<div class="form-group">
				...
				<input type="text" id="titreQuestionTxtTrou" class="form-control" name="titleQuestTxtTrou" maxlength="75" required>
			</div>
			<div class="form-group">
				<label><?php echo $translation['question'][$lang]; ?> :</label>
				<input type="text" id="questionTxtTrou" class="form-control" name="questionTxtTrou" maxlength="150" required>
			</div>
			<div class="form-group">
				<label><?php echo $translation['texte_a_trou'][$lang]; ?> :</label>
				<textarea rows="4" cols="50" id="txtTrou" class="form-control" name="txtTrou" placeholder="Ceci est INPUT1 exemple de texte à INPUT2." required></textarea>
				<small id="repHelpTrou" class="form-text text-muted"><?php echo $translation['remplacer_mot_input'][$lang]; ?></small>
				<br>
				<p id="HelpNbTrou" class="form-text"><?php echo $translation['nb_mot_input'][$lang]; ?></p>
			</div>
			<div class="form-group">
				<label>Input 1 :</label>
				<input type="text" id="inputTxtTrou1" placeholder="un" class="form-control" name="inputTxtTrou1" maxlength="50" required>
			</div>
			<div class="form-group">
				<label>Input 2 :</label>
				<input type="text" id="inputTxtTrou2" placeholder="trous" class="form-control" name="inputTxtTrou2" maxlength="50" required>
			</div>
			<div class="form-group">
				<label>Input 3 :</label>
				<input type="text" id="inputTxtTrou3" class="form-control" name="inputTxtTrou3" maxlength="50" required>
			</div>
			<div class="form-group">
				<label>Input 4 :</label>
				<input type="text" id="inputTxtTrou4" class="form-control" name="inputTxtTrou4" maxlength="50">
			</div>
			<div class="form-group">
				<label>Input 5 :</label>
				<input type="text" id="inputTxtTrou5" class="form-control" name="inputTxtTrou5" maxlength="50">
			</div>
			<div class="form-group">
				<label>Input 6 :</label>
				<input type="text" id="inputTxtTrou6" class="form-control" name="inputTxtTrou6" maxlength="50">
			</div>
<!-- 			<div class="form-group">
				<label>Input 7 :</label>
				<input type="text" id="inputTxtTrou7" class="form-control" name="inputTxtTrou7" maxlength="50">
			</div>
			<div class="form-group">
				<label>Input 8 :</label>
				<input type="text" id="inputTxtTrou8" class="form-control" name="inputTxtTrou8" maxlength="50">
			</div>
			<div class="form-group">
				<label>Input 9 :</label>
				<input type="text" id="inputTxtTrou9" class="form-control" name="inputTxtTrou9" maxlength="50">
			</div>
			<div class="form-group">
				<label>Input 10 :</label>
				<input type="text" id="inputTxtTrou10" class="form-control" name="inputTxtTrou10" maxlength="50">
			</div> -->
			<div class="page-header">
				<h2><?php echo $translation['aide_au_defi'][$lang]; ?></h2>
				<label for="aideTxt"><?php echo $translation['texte_aide_defi2'][$lang]; ?> : </label>
				<br/>
				<!-- <textarea rows="6" cols="50" name="aideTxt"></textarea> -->
				<textarea id="editorTrou" class="editor" rows="6" cols="50" name="editorTxtTrou">Texte seulement ! Voir les champs ci dessous pour les images/vidéos/audios</textarea><br/><br/>
				...
				<input type="file" id="aideImgTxtTrou" name="aideImgTxtTrou" accept="image/*"><br/>
				...
				<input type="file" id="aideVideoTxtTrou" name="aideVideoTxtTrou" accept="video/mp4,video/*"><br/>
				...
				<input type="file" id="aideSonTxtTrou" name="aideSonTxtTrou" accept="audio/*"><br/>
