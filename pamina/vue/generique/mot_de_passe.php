...
<body>
	<div>
		<a href="../../../" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> Retour</a>
	</div>
	<div class="container">
		<div class="page-header">
			<h2>Mot de passe oublié</h2>
		</div>
		<form method="post" action="../../model/newPassword.php?lang=FR">
			...
			<div class="row">
				<div class="col-md-12 text-center">
					<button style="margin-bottom: 2%;" type="submit" class="btn btn-primary">Valider</button>
				</div>
			</div>
		</form>
	</div>
